...
An [RxJS](https://github.com/Reactive-Extensions/RxJS) library wrapper that lets you execute Rx operators directly using [marble-diagram](http://rxmarbles.com/) ASCII string arguments.
